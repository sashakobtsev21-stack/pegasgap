...
async def run_pair(
    ...
    420 с): если внутренние таймауты не сработали (зависший браузер), `search()`
    ...
    останавливал сам себя. Отсюда 420 с — вдвое от измеренного худшего случая.
    ...
    timeout_s = (provider_timeout_s if provider_timeout_s is not None
                 else float(os.environ.get("PEGASGAP_PROVIDER_TIMEOUT_S") or 420))
